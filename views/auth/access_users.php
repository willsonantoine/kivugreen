    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="location.href='./membres'">Enregistrer</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    var tab_taches = [];
    var tab_operations = [];
    var isAccess = '<?php echo in_array('DONNER ACCESS', $ALL_ACCESS); ?>';
    var isSendSMS = '<?php echo in_array('ENVOIE SMS', $ALL_ACCESS); ?>';
