...
<head>
    ...
    <title>Créate account || DB Sytem</title>
    <!-- Favicon -->
                    ...
                    <div class="row m-0">
                        <div class="col-md-5 bg-white sign-in-page-data">
                            <div class="sign-in-from">
                                ...
                                <br>
                                <h4 class="mb-0 text-center">Créer un compte entreprise</h4>
                                <p class="text-center text-dark">Veuillez remplir toutes ces informations pour créer votre compte</p>
                                <form class="mt-4">
                                    <div class="form-group">
                                        <label for="name">Nom complet de l'entreprise</label>
                                        <input type="text" id="name" autocomplete="off" class="form-control mb-0 setcolor" placeholder="Nom complet">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Votre adresse mail</label>
                                        <input type="text" id="email" autocomplete="off" class="form-control mb-0 setcolor" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                        <label for="email2">Ecrire en nouveau l'adresse mail</label>
                                        <input type="text" id="email2" autocomplete="off" class="form-control mb-0 setcolor" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                        <label for="username">Numéro de téléphone</label>
                                        <input type="text" id="phone" autocomplete="off" class="form-control mb-0 setcolor" placeholder="+243">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="ville" autocomplete="off" class="form-control mb-0 setcolor" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <label for="username">Adresse complete</label>
                                        <input type="text" id="addresse" autocomplete="off" class="form-control mb-0 setcolor" placeholder="">
                                    </div>

                                    <div class="d-inline-block w-100">
                                        <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                            <input type="checkbox" class="custom-control-input" id="compte_demo">
                                            <label class="custom-control-label" for="compte_demo">Me créer un compte démo</label>
                                        </div>
                                    </div>
                                    <div id="infos"></div>
                                    <div class="sign-info text-center">
                                        <button type="button" id="create" class="btn btn-primary d-block w-100 mb-2">Créer un compte</button>
