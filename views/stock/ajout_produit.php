         ...
         <div class="modal-body">
               ...
               <div class="col-md-8">
                  <div class="row">
                     ...
                     <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control mb-0" id="produitv" name="produit" placeholder="Nom du produit">
                     </div>

                     <div class="form-group col-md-4">
                        <label for="produit_">N° Compte</label>
                        <input type="number" value="" class="form-control mb-0" id="numero" name="numero" placeholder="Numero">
                     </div>

                  </div>
                  <div class="form-group">
                     <label for="categorie_produit">Catégorie</label>
                     <select id="categorie_produit" name="categorie_produit" class="form-control mb-0">
            ...
            <div class="row">
               <div class="form-group col-md-3">
                  ...
                  <input type="number" class="form-control mb-0" id="pv" name="pv" placeholder="Prix de vente">
               </div>
               <div class="form-group col-md-3">
                  <label for="produit_">Prix de vente Min</label>
                  <input type="number" class="form-control mb-0" id="pv_min" name="pv_min" placeholder="Prix de vente Min">
               </div>
               <div class="form-group col-md-3">
                  <label for="produit_">Qte Min</label>
                  <input type="number" class="form-control mb-0" id="qte_min" name="qte_min" placeholder="Quantite Min">
               </div>
               <div class="form-group col-md-3">
                  <label for="points">Points</label>
                  <input type="number" class="form-control mb-0" id="points" name="qte_min" placeholder="0">
               </div>
               <div class="form-group col-md-12">
                  <label for="description_prod">Description</label>
                  <input type="text" class="form-control mb-0" id="description_prod" name="description" placeholder="Description du produit">
               </div>
            </div>
            <div id="txy"></div>
         </div>
